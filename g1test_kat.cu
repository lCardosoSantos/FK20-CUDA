...
__managed__ g1p_t
    ...
    g1p_wG = {
        { 0x951E61C4A0BDE9DF, 0xA1A065C201E5428F, 0xAD36AF12597FFDF9, 0x842AF1627877C3DF, 0x436DBC70112A0BBF, 0x073BBE98556CD353, }, // 0x073BBE98556CD353436DBC70112A0BBF842AF1627877C3DFAD36AF12597FFDF9A1A065C201E5428F951E61C4A0BDE9DF
        { 0xAEAF5BE7EF4B70AD, 0x062FD2447CDB3896, 0xA06FC75137CA5DCB, 0x1AB03AAABE443F64, 0xE5EBAFCA47737674, 0x10163DEFE498CE7D, }, // 0x10163DEFE498CE7DE5EBAFCA477376741AB03AAABE443F64A06FC75137CA5DCB062FD2447CDB3896AEAF5BE7EF4B70AD
        { 0xD1C9C27F59A653F2, 0x6DFF25F9B88758ED, 0x30FBB18F0E924D50, 0xB44FC9976DE2A4A9, 0xA6295B575EFA3704, 0x07FE91B85CB63138, }, // 0x07FE91B85CB63138A6295B575EFA3704B44FC9976DE2A4A930FBB18F0E924D506DFF25F9B88758EDD1C9C27F59A653F2
    },
    g1p_w8G = {
        { 0x9CA68F3EA252BA20, 0x524D45694740096C, 0x440579E04D9B78B0, 0x06555D5245A6AFB4, 0x562633C82E55FAB5, 0x0391C12884C4A0ED, }, // 0x0391C12884C4A0ED562633C82E55FAB506555D5245A6AFB4440579E04D9B78B0524D45694740096C9CA68F3EA252BA20
        { 0xFFF60428B6D82D94, 0xBA9679E9AD297AE9, 0xD36D691FD2CF9952, 0x10F5DAA7C8422136, 0x9E2B86BD8BC2C1E8, 0x15499308843A28CA, }, // 0x15499308843A28CA9E2B86BD8BC2C1E810F5DAA7C8422136D36D691FD2CF9952BA9679E9AD297AE9FFF60428B6D82D94
        { 0xA2EF1FAF454DA466, 0x07BF1B036BBAE5F4, 0x8AE46951FB82768B, 0x388DF73B54D6A904, 0x0FC3E30846EB73C1, 0x0411762C52A48DC5, }, // 0x0411762C52A48DC50FC3E30846EB73C1388DF73B54D6A9048AE46951FB82768B07BF1B036BBAE5F4A2EF1FAF454DA466
    };
...
/*
    ...
    if (pass) {
        ...
        g1p_multi(1, &p, NULL, &p, NULL);   // p = w^1*p

        if (g1p_neq(p, g1p_wG)) {
            pass = false;

            g1p_print("FAIL: w^1*G !=  ", p);
        }
        ++count;
    }

    if (pass) {
        g1p_multi(7, &p, NULL, &p, NULL);   // p = w^7*p

        if (g1p_neq(p, g1p_w8G)) {
            pass = false;

            g1p_print("FAIL: w^8*G !=  ", p);
        }
        ++count;
    }
*/
