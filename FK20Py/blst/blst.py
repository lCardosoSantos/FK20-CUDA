...
class Scalar(object):
    ...
    hash_to = _swig_new_instance_method(_blst.Scalar_hash_to)
    ...
    to_bendian = _swig_new_instance_method(_blst.Scalar_to_bendian)
    to_lendian = _swig_new_instance_method(_blst.Scalar_to_lendian)
    add = _swig_new_instance_method(_blst.Scalar_add)
    sub = _swig_new_instance_method(_blst.Scalar_sub)
    mul = _swig_new_instance_method(_blst.Scalar_mul)
...
P1_Affines_mult_pippenger = _blst.P1_Affines_mult_pippenger
...
P2_Affines_mult_pippenger = _blst.P2_Affines_mult_pippenger
P2_Affines_add = _blst.P2_Affines_add
P2_Affines_as_memory = _blst.P2_Affines_as_memory
...
class PT(object):
    ...
    in_group = _swig_new_instance_method(_blst.PT_in_group)
    to_bendian = _swig_new_instance_method(_blst.PT_to_bendian)
    finalverify = _swig_new_static_method(_blst.PT_finalverify)
